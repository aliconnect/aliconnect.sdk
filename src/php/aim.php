...
//             'operationId'=> "\Aim\Item($schemaName).search",
//             'parameters'=> [
//               $par_select,
...
//             'operationId'=> "\Aim\Item($schemaName).get",
//             'parameters'=> [
//               $par_id,
//               $par_select,
//             ],
...
//               'description'=> "Returns a single $schemaName object",
//               // 'operationId'=> "(new item('$schemaName',{id}))->get();",
//               'operationId'=> "\Aim\Item($schemaName).children",
//               'parameters'=> [
//                 $par_id,
//                 $par_select,
//               ],
...
//               'operationId'=> "\Aim\Item($schemaName).add",
//               'requestBody'=> [
...
//               'operationId'=> "\Aim\Item($schemaName).post",
//               'parameters'=> [
//                 $par_id,
//               ],
//               'requestBody'=> [
...
//               'operationId'=> "\Aim\Item($schemaName).patch",
//               'parameters'=> [
//                 $par_id,
//               ],
//               'requestBody'=> [
...
//               'operationId'=> "\Aim\Item($schemaName).delete",
//               'parameters'=> [
//                 $par_id,
//               ],
//               'responses'=> $response,
