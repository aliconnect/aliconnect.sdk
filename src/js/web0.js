(function (){
  ...
  window.addEventListener('load', e => {
    for (var name in document.body) {
      console.log(name, typeof document.body[name], document.body[name]);
    }
    // console.log(document.body);

  })

  console.log(Object.getOwnPropertyDescriptors(Object.getPrototypeOf(Element)));
