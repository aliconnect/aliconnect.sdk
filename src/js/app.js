          ...
          elem.text('').append(
            $('nav').append(
              ...
              $('a').class('icn-verder').style('margin-left:auto;').text('Bestellen').on('click', e => {
                const elemBestel = $('div').parent(document.body).append(
                  $('nav').append(
                    ...
                    $('a').class('icn-verder').style('margin-left:auto;').text('Verzenden').on('click', async e => {
                      await api('/abis/bestel_verzend'+document.location.search).query().get();
                      elemBestel.remove();
                      elem.remove();
                      // alert('Verzonden');
                    }),
  ...
  function menu(){
    $(document.body).text('').append(
      $('div').class('list').append(
        ...
        $('div').class('icn-shop panel').text('Bestellijst').on('click', e => methods.bestellijst()),
