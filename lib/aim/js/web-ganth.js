(function(){
  ...
  Ganth = Object.create({
    ...
    init(data, ganthElement) {
      // $('link').attr('rel', 'stylesheet').attr('href', '/v1/src/css/ganth.css').parent(document.head);
      this.el = this.ganthElement = ganthElement.class('col ganth').text('');
    ...
    goToday() {
      this.ganthElement.el.parentElement.scrollLeft = this.left(new Date()) - 200;
    },
    closeview() {
