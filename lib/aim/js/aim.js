      ...
      if (document) {
        ...
        globalSystems.forEach(item => {
          ...
          Object.entries(properties).filter(([name,property]) => !item.hasOwnProperty(name)).forEach(([name,property]) => {
            ...
            const {readOnly,options} = property;
            let to;
            Object.defineProperty(item, name, {
              ...
              set(value) {
                ...
                if (data[name] != value) {
                  data[name] = value;
                  if (socketClient && event.type !== 'message') {
        ...
        items.forEach((item,i) => {
          ...
          propertiesArray.forEach(([name,property]) => {
            const {readOnly,modbus,fc,register,readInterval,options} = property;
            let toCheck;
            ...
            Object.defineProperty(item, name, {
              ...
              set(value){
                if (data[name] != value) {
                  console.debug(name.padStart(30), value);
