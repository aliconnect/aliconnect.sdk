...
(function (root, factory) {
  ...
  Object.defineProperties(Aim.prototype, {
    ...
    emit: {value: async function(type, context){
    ...
    getObject: {value: function(name, constructor, args) {
    ...
    schemas: {value: function(selector, context){
  ...
  Object.defineProperties(Item.prototype, {
    ...
    className: { get() {
      ...
      const allOf = this.schema && this.schema.allOf ? this.schema.allOf : [];
      return [
    ...
    properties: { get() {
      return this.schema && this.schema.properties ? this.schema.properties : {};
    },},
    post: {
